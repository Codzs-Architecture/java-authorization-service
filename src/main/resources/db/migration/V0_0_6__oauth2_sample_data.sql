...
INSERT IGNORE INTO `oauth2_authorization_consent` VALUES ('1','admin','ROLE_ADMIN');

INSERT IGNORE INTO `users` VALUES ('admin','{bcrypt}$2a$10$63CNAw69rPATq7hoyGbQFe4GojJ.xK9bNWs1rH88U0GPiHyK2ueIC',1);
