...
/**
 * Service interface for DatabaseSchema-related business operations.
...
public interface DatabaseSchemaService {
    ...
    /**
     * Checks if service type already exists for an organization.
     *
     * @param organizationId the organization ID
     * @param forService the service type
     * @param excludeSchemaId ID to exclude from check (for updates)
     * @return true if service type exists
     */
    boolean isServiceExists(String organizationId, String forService, String excludeSchemaId);
}