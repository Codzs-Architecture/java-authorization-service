...
public class OAuth2SecurityFilterChainConfig {
	...
	private static final String CUSTOM_CONSENT_PAGE_URI = OAuth2Constant.Endpoints.CONSENT;
		...
		http
			...
			.with(authorizationServerConfigurer, (authorizationServer) ->
				authorizationServer
					...
					.deviceAuthorizationEndpoint(deviceAuthorizationEndpoint ->
						deviceAuthorizationEndpoint.verificationUri(OAuth2Constant.Endpoints.DEVICE_ACTIVATION)
					)
			...
			.exceptionHandling((exceptions) -> exceptions
				.defaultAuthenticationEntryPointFor(
					new LoginUrlAuthenticationEntryPoint(OAuth2Constant.Endpoints.LOGIN),
