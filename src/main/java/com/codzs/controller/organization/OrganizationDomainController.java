...
public class OrganizationDomainController {
    ...
    public ResponseEntity<DomainResponseDto> getDomainDetails(
        ...
        return organizationDomainService.getDomainInEntity(organizationId, domainId)
                .map(domain -> {
                ...
                .orElseGet(() -> {
                    log.warn("Domain not found: {} for organization: {}", domainId, organizationId);
