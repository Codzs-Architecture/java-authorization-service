...
/**
 * Configuration enum for ORGANIZATION_SETTING_KEY parameters from config server.
 * This class maps the configuration from the param table in the config database.
 * 
 * Available options include: language, timezone, currency, country
 * 
...
@Order(-1)
public class OrganizationSettingKeyEnum extends ConfigParameterBase {

    @Value("${organization.setting.key.options:}")
