 ...
 * 
 * Available options include: number, string
 * 
...
@Order(-1)
public class OrganizationSettingTypeEnum extends ConfigParameterBase {

    @Value("${organization.setting.type.options:}")
    private String optionsString;
    
    @Value("${organization.setting.type.description:}")
    private String description;
    
    @Value("${organization.setting.type.default:}")
