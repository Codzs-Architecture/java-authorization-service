...
/**
 * Configuration enum for ORGANIZATION_INDUSTRY parameters from config server.
 * This class maps the configuration from the param table in the config database.
 * 
 * Available options include: TECHNOLOGY, FINANCE, HEALTHCARE, EDUCATION, etc.
 * 
...
@Order(-1)
public class OrganizationIndustryEnum extends ConfigParameterBase {

    @Value("${organization.industry.options:}")
